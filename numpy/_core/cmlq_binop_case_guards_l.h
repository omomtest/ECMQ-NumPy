...
case NB_POWER:
{
    ...
    )
    {
        ...
        locality_cache[next_result_cache_index].stats.instr_ptr = instr;
            ...
            specializer_info.SpecializeInstruction(instr, SLOT_ADOUBLE_SQUARE_POWER_SFLOAT, cmlq_adouble_square_power_sfloat, &locality_cache[next_result_cache_index]);
        return 1;
    ...
    )
    {
        ...
        locality_cache[next_result_cache_index].stats.instr_ptr = instr;
            ...
            specializer_info.SpecializeInstruction(instr, SLOT_ADOUBLE_SQUARE_POWER_SLONG, cmlq_adouble_square_power_slong, &locality_cache[next_result_cache_index]);
        return 1;
